...
var associations = [
  { activity: "zumba", genres: ["Latin", "Dancehall", "Salsa", "Merengue"] },
  ...
  { activity: "HIIT", genres: ["Electronic", "Rock", "Pop", "Hip Hop"] },
  ...
  { activity: "yoga", genres: ["Mellow", "R&B", "Trip-Hop", "Chill"] },

  { activity: "stretching", genres: ["Mellow", "R&B", "Trip-Hop", "Chill"] },

  { activity: "rowing", genres: ["Metal", "Pop", "Hip-Hop", "Heavy Rock"] },

  { activity: "biking", genres: ["Electronic", "Pop", "Punk", "Reggae"] },

  { activity: "hiking", genres: ["Punk", "World Music", "Rock", "Reggae"] },
...
module.exports = function(app) {
  app.post("/api/music", function(req, res) {
    ...
    db.Song.findAll({
      where: { genre_name: { [Sequelize.Op.or]: musicGenres } }
